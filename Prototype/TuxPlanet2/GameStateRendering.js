...
let GameStateRendering = {
    render: function (gameState, displayOutput, renderKonqiHitbox) {
        ...
        if (gameState.playerState.isDeadFrameCount === null) {
            ...
            displayOutput.drawImageRotatedClockwise(4 /* GameImage.KonqiAir */, 32 * konqiSpriteNum, 128, 32, 32, (gameState.playerState.xMibi >> 10) - 56, (gameState.playerState.yMibi >> 10) - 48, 0, 128 * 3);
            ...
            displayOutput.drawImageRotatedClockwise(4 /* GameImage.KonqiAir */, 128 + 32 * konqiSpriteNum, 32, 32, 32, (gameState.playerState.xMibi >> 10) - 48, ((gameState.playerState.yMibi + yPositionOffset) >> 10) - 48, 0, 128 * 3);
        }
        for (let playerBullet of gameState.playerBulletState.playerBullets) {
            ...
            displayOutput.drawImageRotatedClockwise(5 /* GameImage.TinyFlame */, imageX, imageY, 8, 8, (playerBullet.xMibi >> 10) - 12, (playerBullet.yMibi >> 10) - 12, playerBullet.displayRotationScaled, 128 * 3);
        }
