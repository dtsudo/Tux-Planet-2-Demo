let MusicVolumePickerUtil = {
    getMusicVolumePicker: function (xPos, yPos, initialVolume) {
        ...
        let render = function (displayOutput) {
            if (currentVolume > 0)
                displayOutput.drawImage(2 /* GameImage.MusicOn */, xPos, yPos);
            else
                displayOutput.drawImage(3 /* GameImage.MusicOff */, xPos, yPos);
